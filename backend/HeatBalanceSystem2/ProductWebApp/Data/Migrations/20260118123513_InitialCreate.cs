...
namespace ProductWebApp.Data.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InputDataSets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InputDataSets_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    InputDataSetId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CalculationRuns_InputDataSets_InputDataSetId",
                        column: x => x.InputDataSetId,
                        principalTable: "InputDataSets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalculationRuns_InputDataSetId_ExecutedAt",
                table: "CalculationRuns",
                columns: new[] { "InputDataSetId", "ExecutedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_InputDataSets_OwnerId_Name",
                table: "InputDataSets",
